...
export const SKILLS = [
  ...
  {id:'acc', ic:'🎯', nm:'Accuracy',      desc:'on-target placement',               cost:1100},
...
// independent of Accuracy, cut by Spectral/Frost magic), or score a GOAL.
export const SAVE_BASE = 0.20;     // keeper save chance — independent of Accuracy
export const ACC_BASE = 0.72, ACC_PER = 0.022, ACC_MAX = 0.99;   // Accuracy = on-target placement (else the shot goes wide)
