...
| `reef/`, `shore/`, `snow/` | — | Coral Reef / Sunny Shore / Snow Day collectibles — **transparent PNGs** (Layer AI generated, keyed off white locally). Same dual use as the SVGs; `view` is the pixel size. |
