...
const GAMEPLAY_RULES = [
  ...
  { id: 'revealOnUnlock', name: 'Reveal on Unlock', icon: '🔓',
    ...
    default: false },
  { id: 'revealLockedCards', name: 'Reveal Locked Cards', icon: '🔍',
    desc: 'Locked, iced, and color-locked cards sit face-up so you can see their color while they\'re locked. The moment one unlocks it flips face-down — remember it!',
    default: true },
  ...
  { id: 'coloredBombs', name: 'Colored Bombs', icon: '🎨',
    ...
    default: false },
  { id: 'bombChainStay', name: 'Bomb Extends Chain', icon: '💣',
    desc: 'When a bomb uncovers cards matching your active chain color, add them to the chain and leave them on the board (they resolve with the chain). Off = the bomb collects them like any other card.',
    default: true },
  { id: 'bombRevealNewCards', name: 'Bomb Refill Revealed', icon: '🎴',
    desc: 'Cards that drop in to replace the ones a bomb destroyed arrive briefly revealed. Off = they arrive face-down.',
    default: false },
